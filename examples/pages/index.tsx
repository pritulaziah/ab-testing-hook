...
const getTrafficData = (
  trafficPercentRange: IMyExperiment['trafficPercentRange'] = 1,
) => {
  const [min, max] = Array.isArray(trafficPercentRange)
    ? trafficPercentRange
...
const Home: NextPage<IProps> = ({ userId, experiments }) => {
  ...
  return (
    <ABTestProvider userId={exampleUserId} experiments={exampleExperiment}>
      <Head>
        ...
        <div className="mb-10">
          ...
          <div className="flex flex-col">
            <h4 className="text-md text-slate-800 mb-2 font-medium">
              Example experiment: {exampleExperiment.name}
            </h4>
            <div className="flex">
              ...
              <div className="h-auto ml-4">
                <PieChart
                  data={getTrafficData(exampleExperiment.trafficPercentRange)}
                  label={({ dataEntry }) =>
                    `${dataEntry.title}: ${Math.round(dataEntry.percentage)}%`
                  }
                  labelStyle={{
